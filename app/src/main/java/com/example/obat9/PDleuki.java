...
public class PDleuki extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdleuki);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara004leukimia);
    ...
    public void RLeuki(View view) {
        Intent intent = new Intent(PDleuki.this, RPDleuki.class);

...
public class RPKkurap extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kurap1, R.drawable.kurap2, R.drawable.kurap3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkkurap);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskurap);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKkurap.this, PKkurap.class);
        startActivity(intent);
        audioBackground.stop();
        RPKkurap.this.finish();
    }

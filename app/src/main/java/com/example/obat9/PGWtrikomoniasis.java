...
public class PGWtrikomoniasis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwtrikomoniasis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.triko);
    ...
    public void onBackPressed() {
        ...
        PGWtrikomoniasis.this.finish();
    }
    public void Rtrikomoniasis(View view) {
        Intent intent = new Intent(PGWtrikomoniasis.this, RPGtrikomoniasis.class);

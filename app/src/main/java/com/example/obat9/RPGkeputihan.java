...
public class RPGkeputihan extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.keputihan1, R.drawable.keputihan2, R.drawable.keputihan3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgkeputihan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskeputihan);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGkeputihan.this, PGWkeputihan.class);
        startActivity(intent);
        audioBackground.stop();
        RPGkeputihan.this.finish();
    }

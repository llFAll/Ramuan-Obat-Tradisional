...
public class PGWchlamydia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwchlamydia);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.chlamydia);
    ...
    public void onBackPressed() {
        ...
        PGWchlamydia.this.finish();
    }
    public void Rchlamidia(View view) {
        Intent intent = new Intent(PGWchlamydia.this, RPGchlamydia.class);

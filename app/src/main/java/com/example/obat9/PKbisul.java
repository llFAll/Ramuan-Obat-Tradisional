...
public class PKbisul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkbisul);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara012bisul);
    ...
    public void Rbisul(View view) {
        Intent intent = new Intent(PKbisul.this, RPKbisul.class);

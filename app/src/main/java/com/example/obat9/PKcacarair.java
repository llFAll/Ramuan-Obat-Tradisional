...
public class PKcacarair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkcacarair);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara013cacarair);
    ...
    public void onBackPressed() {
        ...
        PKcacarair.this.finish();
    }
    public void Rcacarair(View view) {
        Intent intent = new Intent(PKcacarair.this, RPKcacarair.class);

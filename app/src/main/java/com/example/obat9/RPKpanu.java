...
public class RPKpanu extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.panu1, R.drawable.panu2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkpanu);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rspanu);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKpanu.this, PKpanu.class);

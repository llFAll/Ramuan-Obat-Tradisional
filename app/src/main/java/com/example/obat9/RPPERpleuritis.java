...
public class RPPERpleuritis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.pleuritis1, R.drawable.pleuritis2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperpleuritis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rspleuritis);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERpleuritis.this, PAPERpleuritis.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERpleuritis.this.finish();
    }

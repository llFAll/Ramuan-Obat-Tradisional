...
public class PAPERsariawan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papersariawan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara029sariawan);
    ...
    public void onBackPressed() {
        ...
        PAPERsariawan.this.finish();
    }
    public void Rsariawan(View view) {
        Intent intent = new Intent(PAPERsariawan.this, RPPERsariawan.class);

...
public class RPPERgondongan extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.gondongan1, R.drawable.gondongan2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppergondongan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsgondongan);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERgondongan.this, PAPERgondongan.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERgondongan.this.finish();
    }

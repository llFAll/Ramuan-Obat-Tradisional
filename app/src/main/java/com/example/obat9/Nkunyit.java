...
public class Nkunyit extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kunyit1, R.drawable.kunyit2, R.drawable.kunyit3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nkunyit);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara001kunyit);

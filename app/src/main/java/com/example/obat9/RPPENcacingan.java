...
public class RPPENcacingan extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.cacingan1, R.drawable.cacingan2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppencacingan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rscacingan);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENcacingan.this, PAPENcacingan.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENcacingan.this.finish();
    }

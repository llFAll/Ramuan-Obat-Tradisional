...
public class PDradangmata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdradangmata);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara006radangmata);
    ...
    public void onBackPressed() {
        ...
        PDradangmata.this.finish();

    }
    public void RRadangMata(View view) {
        Intent intent = new Intent(PDradangmata.this, RPDradangmata.class);

...
public class RPPERamandel extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.amandel2, R.drawable.amandel1};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperamandel);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsamandel);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERamandel.this, PAPERamandel.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERamandel.this.finish();
    }

...
public class Nbrotowali extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.brotowali1, R.drawable.brotowali2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nbrotowali);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara008brotowali);

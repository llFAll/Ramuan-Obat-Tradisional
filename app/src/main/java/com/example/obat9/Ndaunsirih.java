...
public class Ndaunsirih extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.sirih1, R.drawable.sirih2, R.drawable.sirih3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ndaunsirih);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara005daunsirih);

...
public class RPPERdifteri extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.difteri2, R.drawable.difteri1};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperdifteri);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsdisteri);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERdifteri.this, PAPERdifteri.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERdifteri.this.finish();
    }

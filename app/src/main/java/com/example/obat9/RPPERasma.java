...
public class RPPERasma extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.asma2, R.drawable.asma1, R.drawable.asma3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperasma);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsasma);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERasma.this, PAPERasma.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERasma.this.finish();
    }

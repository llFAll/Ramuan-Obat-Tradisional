...
public class RPKcampak extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.campak1, R.drawable.campak2, R.drawable.campak3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkcampak);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rscampak);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKcampak.this, PKcampak.class);
        startActivity(intent);
        audioBackground.stop();
        RPKcampak.this.finish();
    }

...
public class Ngandarusa extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.gandarusa1, R.drawable.gandarusa2, R.drawable.gandarusa3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ngandarusa);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara006gandarusa);

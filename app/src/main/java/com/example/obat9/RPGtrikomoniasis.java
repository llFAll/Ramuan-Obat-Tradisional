...
public class RPGtrikomoniasis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.trikomo1, R.drawable.trikomo2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgtrikomoniasis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rstrikomoniasis);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGtrikomoniasis.this, PGWtrikomoniasis.class);
        startActivity(intent);
        audioBackground.stop();
        RPGtrikomoniasis.this.finish();
    }

...
public class RPPENwasir extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.wasir1, R.drawable.wasir2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppenwasir);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rswasir);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENwasir.this, PAPENwasir.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENwasir.this.finish();
    }

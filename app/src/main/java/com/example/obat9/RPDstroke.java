...
public class RPDstroke extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.stroke1, R.drawable.stroke2, R.drawable.stroke3, R.drawable.stroke4, R.drawable.stroke5};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdstroke);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatstroke);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDstroke.this, PDstroke.class);
        startActivity(intent);
        audioBackground.stop();
        RPDstroke.this.finish();
    }
    @Override

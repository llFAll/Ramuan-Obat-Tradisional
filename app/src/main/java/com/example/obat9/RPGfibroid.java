...
public class RPGfibroid extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.fibroid1, R.drawable.fibroid2, R.drawable.fibroid3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgfibroid);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsfibroid);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGfibroid.this, PGWfibroidrahim.class);
        startActivity(intent);
        audioBackground.stop();
        RPGfibroid.this.finish();
    }

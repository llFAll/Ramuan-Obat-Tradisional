...
public class RPKkoreng extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.koreng1, R.drawable.koreng2, R.drawable.koreng3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkkoreng);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskoreng);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKkoreng.this, PKkoreng.class);
        startActivity(intent);
        audioBackground.stop();
        RPKkoreng.this.finish();
    }

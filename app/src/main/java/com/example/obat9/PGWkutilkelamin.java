...
public class PGWkutilkelamin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwkutilkelamin);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.kutilkelamin);
    ...
    public void onBackPressed() {
        ...
        PGWkutilkelamin.this.finish();
    }
    public void Rkutilkelamin(View view) {
        Intent intent = new Intent(PGWkutilkelamin.this, RPGkutilkelamin.class);

...
public class PKpanu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkpanu);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara020panu);
    ...
    public void Rpanu(View view) {
        Intent intent = new Intent(PKpanu.this, RPKpanu.class);

...
public class RPGgonore extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.gonore1, R.drawable.gonore2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpggonore);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsgonore);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGgonore.this, PGWgonore.class);
        startActivity(intent);
        audioBackground.stop();
        RPGgonore.this.finish();
    }

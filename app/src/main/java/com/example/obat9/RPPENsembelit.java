...
public class RPPENsembelit extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.semeblit1, R.drawable.semeblit2, R.drawable.semeblit3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppensembelit);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rssembelit);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENsembelit.this, PAPENsembelit.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENsembelit.this.finish();
    }

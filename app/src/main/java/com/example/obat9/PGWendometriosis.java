...
public class PGWendometriosis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwendometriosis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.endometriosis);
    ...
    public void onBackPressed() {
        ...
        PGWendometriosis.this.finish();
    }
    public void Rendometri(View view) {
        Intent intent = new Intent(PGWendometriosis.this, RPGendometriosis.class);

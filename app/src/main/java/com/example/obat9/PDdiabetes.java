...
public class PDdiabetes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pddiabetes);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara003diabetes);
    ...
    public void onBackPressed() {
        ...
        PDdiabetes.this.finish();

    }
    public void RDiabetes(View view) {
        Intent intent = new Intent(PDdiabetes.this, RPDdiabetes.class);

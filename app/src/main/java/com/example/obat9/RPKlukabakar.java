...
public class RPKlukabakar extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.lukabakar1, R.drawable.lukabakar2, R.drawable.lukabakar3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpklukabakar);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rslukabakar);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKlukabakar.this, PKlukabakar.class);
        startActivity(intent);
        audioBackground.stop();
        RPKlukabakar.this.finish();
    }

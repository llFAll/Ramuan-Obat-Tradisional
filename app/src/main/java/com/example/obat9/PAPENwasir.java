...
public class PAPENwasir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papenwasir);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara020wasir);
    ...
    public void onBackPressed() {
        ...
        PAPENwasir.this.finish();
    }
    public void Rwasir(View view) {
        Intent intent = new Intent(PAPENwasir.this, RPPENwasir.class);

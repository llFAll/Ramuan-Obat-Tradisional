...
public class PDmalaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdmalaria);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara005malaria);
    ...
    public void onBackPressed() {
        ...
        PDmalaria.this.finish();

    }
    public void RMalaria(View view) {
        Intent intent = new Intent(PDmalaria.this, RPDmalaria.class);

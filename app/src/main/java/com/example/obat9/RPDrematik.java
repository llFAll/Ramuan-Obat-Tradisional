...
public class RPDrematik extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.rematik1, R.drawable.rematik2, R.drawable.rematik3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdrematik);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatrematik);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDrematik.this, PDrematik.class);
        startActivity(intent);
        audioBackground.stop();
        RPDrematik.this.finish();
    }

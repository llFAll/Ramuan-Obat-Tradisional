...
public class RPKbisul extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.bisul1, R.drawable.bisul2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkbisul);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsbisul);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKbisul.this, PKbisul.class);
        startActivity(intent);
        audioBackground.stop();
        RPKbisul.this.finish();
    }

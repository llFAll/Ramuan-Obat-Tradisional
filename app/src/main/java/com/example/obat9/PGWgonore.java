...
public class PGWgonore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwgonore);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.gonore);
    ...
    public void onBackPressed() {
        ...
        PGWgonore.this.finish();
    }
    public void Rgonore(View view) {
        Intent intent = new Intent(PGWgonore.this, RPGgonore.class);

...
public class RPPENhepatitis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.hepatitis1, R.drawable.hepatitis2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppenhepatitis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rshepatitis);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENhepatitis.this, PAPENhepatitis.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENhepatitis.this.finish();
    }

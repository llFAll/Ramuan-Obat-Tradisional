...
public class PKkusta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkkusta);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara018kusta);
    ...
    public void Rkusta(View view) {
        Intent intent = new Intent(PKkusta.this, RPKkusta.class);

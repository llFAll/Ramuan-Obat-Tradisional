...
public class RPPERtbc extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.tbc1, R.drawable.tbc2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppertbc);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rstbc);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERtbc.this, PAPERtbc.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERtbc.this.finish();
    }

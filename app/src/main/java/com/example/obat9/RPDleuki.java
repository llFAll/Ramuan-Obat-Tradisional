...
public class RPDleuki extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.leuki1, R.drawable.leuki2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdleuki);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatleukimia);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDleuki.this, PDleuki.class);
        startActivity(intent);
        audioBackground.stop();
        RPDleuki.this.finish();
    }
    @Override

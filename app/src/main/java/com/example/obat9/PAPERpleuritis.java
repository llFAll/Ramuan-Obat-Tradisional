...
public class PAPERpleuritis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperpleuritis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara027pleuritis);
    ...
    public void onBackPressed() {
        ...
        PAPERpleuritis.this.finish();
    }
    public void Rpleuritis(View view) {
        Intent intent = new Intent(PAPERpleuritis.this, RPPERpleuritis.class);

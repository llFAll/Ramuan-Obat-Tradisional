...
public class Njahe extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.jahe1, R.drawable.jahe2, R.drawable.jahe3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_njahe);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara004jahe);

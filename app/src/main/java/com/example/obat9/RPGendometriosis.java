...
public class RPGendometriosis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.endometriosis1, R.drawable.endometriosis2, R.drawable.endometriosis3, R.drawable.endometriosis4, R.drawable.endometriosis5};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgendometriosis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsendometri);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGendometriosis.this, PGWendometriosis.class);
        startActivity(intent);
        audioBackground.stop();
        RPGendometriosis.this.finish();
    }

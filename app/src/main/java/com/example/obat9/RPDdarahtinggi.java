...
public class RPDdarahtinggi extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.tdt1, R.drawable.tdt2, R.drawable.tdt3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpddarahtinggi);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobattekanandarahtinggi);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDdarahtinggi.this, PDdarahtinggi.class);
        startActivity(intent);
        audioBackground.stop();
        RPDdarahtinggi.this.finish();
    }
    @Override

...
public class RPGkankerserviks extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kanker1, R.drawable.kanker2, R.drawable.kanker3, R.drawable.kanker4, R.drawable.kanker5, R.drawable.kanker6, R.drawable.kanker7};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgkankerserviks);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rkankerserviks);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGkankerserviks.this, PGWms.class);
        startActivity(intent);
        audioBackground.stop();
        RPGkankerserviks.this.finish();
    }

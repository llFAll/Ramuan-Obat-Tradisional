...
public class RPKkusta extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kusta1, R.drawable.kusta2, R.drawable.kusta3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkkusta);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskusta);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKkusta.this, PKkusta.class);
        startActivity(intent);
        audioBackground.stop();
        RPKkusta.this.finish();
    }

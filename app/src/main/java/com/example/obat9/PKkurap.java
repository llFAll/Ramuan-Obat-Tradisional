...
public class PKkurap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkkurap);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara016kurap);
    ...
    public void Rkurap(View view) {
        Intent intent = new Intent(PKkurap.this, RPKkurap.class);

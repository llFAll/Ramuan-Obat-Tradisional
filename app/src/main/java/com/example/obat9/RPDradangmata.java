...
public class RPDradangmata extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.mata1, R.drawable.mata2, R.drawable.mata3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdradangmata);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatradangmata);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDradangmata.this, PDradangmata.class);
        startActivity(intent);
        audioBackground.stop();
        RPDradangmata.this.finish();
    }
    @Override

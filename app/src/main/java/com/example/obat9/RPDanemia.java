...
public class RPDanemia extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.ranemia1, R.drawable.ranemia2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdanemia);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatanemia);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDanemia.this, PDanemia.class);
        startActivity(intent);
        audioBackground.stop();
        RPDanemia.this.finish();
    }

...
public class RPPERbronkitis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.bronkitis1, R.drawable.bronkitis2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperbronkitis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsbronkitis);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERbronkitis.this, PAPERbrokitis.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERbronkitis.this.finish();
    }

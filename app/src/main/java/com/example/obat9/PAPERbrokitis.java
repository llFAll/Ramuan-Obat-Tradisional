...
public class PAPERbrokitis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperbrokitis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara023bronkritis);
    ...
    public void onBackPressed() {
        ...
        PAPERbrokitis.this.finish();
    }
    public void Rbronkitis(View view) {
        Intent intent = new Intent(PAPERbrokitis.this, RPPERbronkitis.class);

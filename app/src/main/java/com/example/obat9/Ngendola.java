...
public class Ngendola extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.gendola1, R.drawable.gendola2, R.drawable.gendola3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ngendola);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara009gendola);

...
public class PAPENsembelit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papensembelit);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara019sembelit);
    ...
    public void onBackPressed() {
        ...
        PAPENsembelit.this.finish();
    }
    public void Rsembelit(View view) {
        Intent intent = new Intent(PAPENsembelit.this, RPPENsembelit.class);

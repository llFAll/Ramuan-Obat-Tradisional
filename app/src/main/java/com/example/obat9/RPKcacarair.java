...
public class RPKcacarair extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.cacarair1, R.drawable.cacarair2, R.drawable.cacarair3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkcacarair);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rscacarair);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKcacarair.this, PKcacarair.class);
        startActivity(intent);
        audioBackground.stop();
        RPKcacarair.this.finish();
    }

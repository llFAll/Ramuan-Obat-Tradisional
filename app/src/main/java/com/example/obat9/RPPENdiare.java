...
public class RPPENdiare extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.diare1, R.drawable.diare2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppendiare);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsdiare);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENdiare.this, PAPENdiare.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENdiare.this.finish();
    }

...
public class PGWms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwms);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.kankerserviks);
    ...
    public void Rkanker(View view) {
        Intent intent = new Intent(PGWms.this, RPGkankerserviks.class);

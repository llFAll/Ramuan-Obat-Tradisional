...
public class PGWfibroidrahim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwfibroidrahim);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.fibroid);
    ...
    public void onBackPressed() {
        ...
        PGWfibroidrahim.this.finish();
    }
    public void Rfibroid(View view) {
        Intent intent = new Intent(PGWfibroidrahim.this, RPGfibroid.class);

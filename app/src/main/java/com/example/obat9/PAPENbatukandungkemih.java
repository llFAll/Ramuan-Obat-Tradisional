...
public class PAPENbatukandungkemih extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papenbatukandungkemih);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara011batukandungkemih);
    ...
    public void onBackPressed() {
        ...
        PAPENbatukandungkemih.this.finish();
    }
    public void Rkandungkemih(View view) {
        Intent intent = new Intent(PAPENbatukandungkemih.this, RPPENkandungkemih.class);

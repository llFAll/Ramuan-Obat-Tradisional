...
public class PAPENinfeksisalurankemih extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papeninfeksisalurankemih);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara016infeksisalurankemih);
    ...
    public void onBackPressed() {
        ...
        PAPENinfeksisalurankemih.this.finish();
    }
    public void Rinfeksisalurankemih(View view) {
        Intent intent = new Intent(PAPENinfeksisalurankemih.this, RPPENinfeksisalurankemih.class);

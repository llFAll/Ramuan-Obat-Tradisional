...
public class RPGsifilis extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.sifilis1, R.drawable.sifilis2, R.drawable.sifilis3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgsifilis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rssifilis);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGsifilis.this, PGWsifilis.class);
        startActivity(intent);
        audioBackground.stop();
        RPGsifilis.this.finish();
    }

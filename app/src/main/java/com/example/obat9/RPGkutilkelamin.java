...
public class RPGkutilkelamin extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kutilkelammin1, R.drawable.kutilkelammin2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgkutilkelamin);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskutilkelamin);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGkutilkelamin.this, PGWkutilkelamin.class);
        startActivity(intent);
        audioBackground.stop();
        RPGkutilkelamin.this.finish();
    }

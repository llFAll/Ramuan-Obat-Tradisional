...
public class RPGchlamydia extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.chalymidia1, R.drawable.chalymidia2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpgchlamydia);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rschalmidia);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGchlamydia.this, PGWchlamydia.class);
        startActivity(intent);
        audioBackground.stop();
        RPGchlamydia.this.finish();
    }

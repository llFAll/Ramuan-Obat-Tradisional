...
public class RPPENinfeksisalurankemih extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.infeksisalurankemih1, R.drawable.infeksisalurankemih2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppeninfeksisalurankemih);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsinfeksisalurankandungkemih);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENinfeksisalurankemih.this, PAPENinfeksisalurankemih.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENinfeksisalurankemih.this.finish();
    }

...
public class Ntemulawak extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.temulawak1, R.drawable.temulawak2, R.drawable.temulawak3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ntemulawak);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara003temulawak);

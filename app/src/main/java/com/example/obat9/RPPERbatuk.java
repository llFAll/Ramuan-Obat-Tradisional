...
public class RPPERbatuk extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.batuk1, R.drawable.batuk2, R.drawable.batuk3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperbatuk);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsbatuk);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERbatuk.this, PAPERbatuk.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERbatuk.this.finish();
    }

...
public class PAPENdisentri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papendisentri);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara014disentri);
    ...
    public void onBackPressed() {
        ...
        PAPENdisentri.this.finish();
    }
    public void Rdisentri(View view) {
        Intent intent = new Intent(PAPENdisentri.this, RPPENdisentri.class);

...
public class PGWkeputihan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwkeputihan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.keputihan);
    ...
    public void onBackPressed() {
        ...
        PGWkeputihan.this.finish();
    }
    public void Rkeputihan(View view) {
        Intent intent = new Intent(PGWkeputihan.this, RPGkeputihan.class);

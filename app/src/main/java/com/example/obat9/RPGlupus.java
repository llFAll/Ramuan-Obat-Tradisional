...
public class RPGlupus extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.lupus1, R.drawable.lupus2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpglupus);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rslupus);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPGlupus.this, PGWlupus.class);
        startActivity(intent);
        audioBackground.stop();
        RPGlupus.this.finish();
    }

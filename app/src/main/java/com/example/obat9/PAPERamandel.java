...
public class PAPERamandel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperamandel);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara028radangamandel);
    ...
    public void onBackPressed() {
        ...
        PAPERamandel.this.finish();
    }
    public void Ramandel(View view) {
        Intent intent = new Intent(PAPERamandel.this, RPPERamandel.class);

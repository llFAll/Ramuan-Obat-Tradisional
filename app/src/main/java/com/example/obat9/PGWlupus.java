...
public class PGWlupus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwlupus);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.lupus);
    ...
    public void onBackPressed() {
        ...
        PGWlupus.this.finish();
    }
    public void Rlupus(View view) {
        Intent intent = new Intent(PGWlupus.this, RPGlupus.class);

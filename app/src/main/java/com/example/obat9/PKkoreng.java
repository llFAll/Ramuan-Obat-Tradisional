...
public class PKkoreng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkkoreng);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara015koreng);
    ...
    public void onBackPressed() {
        ...
        PKkoreng.this.finish();
    }
    public void Rkoreng(View view) {
        Intent intent = new Intent(PKkoreng.this, RPKkoreng.class);

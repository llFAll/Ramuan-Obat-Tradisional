...
public class PKcampak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkcampak);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara014campak);
    ...
    public void onBackPressed() {
        ...
        PKcampak.this.finish();
    }
    public void Rcampak(View view) {
        Intent intent = new Intent(PKcampak.this, RPKcampak.class);

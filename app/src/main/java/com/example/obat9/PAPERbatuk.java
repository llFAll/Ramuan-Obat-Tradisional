...
public class PAPERbatuk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperbatuk);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara022batuk);
    ...
    public void onBackPressed() {
        ...
        PAPERbatuk.this.finish();
    }
    public void Rbatuk(View view) {
        Intent intent = new Intent(PAPERbatuk.this, RPPERbatuk.class);

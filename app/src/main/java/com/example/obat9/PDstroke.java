...
public class PDstroke extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdstroke);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara008stroke);
    ...
    public void onBackPressed() {
        ...
        PDstroke.this.finish();

    }
    public void RStroke(View view) {
        Intent intent = new Intent(PDstroke.this, RPDstroke.class);

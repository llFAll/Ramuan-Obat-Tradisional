...
public class RPPENmaag extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.maag1, R.drawable.maag2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppenmaag);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsmaag);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENmaag.this, PAPENmaag.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENmaag.this.finish();
    }

...
public class Nsambiloto extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.sambiloto1, R.drawable.sambiloto2, R.drawable.sambiloto3};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nsambiloto);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara007sambiloto);

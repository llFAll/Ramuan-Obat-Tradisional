...
public class Tdiabetes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tdiabetes);
        ...
        playVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.diabetes);

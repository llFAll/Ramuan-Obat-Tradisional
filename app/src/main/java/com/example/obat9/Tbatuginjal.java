...
public class Tbatuginjal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tbatuginjal);
        ...
        playVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.batuginjal);

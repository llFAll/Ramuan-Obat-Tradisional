...
public class RPDginjal extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.rginjal1, R.drawable.rginjal2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdginjal);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatbatuginjal);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDginjal.this, PDginjal.class);
        startActivity(intent);
        audioBackground.stop();
        RPDginjal.this.finish();
    }

...
public class PAPERtbc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papertbc);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara030tbctuberculosis);
    ...
    public void onBackPressed() {
        ...
        PAPERtbc.this.finish();
    }
    public void Rtbc(View view) {
        Intent intent = new Intent(PAPERtbc.this, RPPERtbc.class);

...
public class PAPENmaag extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papenmaag);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara017maag);
    ...
    public void onBackPressed() {
        ...
        PAPENmaag.this.finish();
    }
    public void Rmaag(View view) {
        Intent intent = new Intent(PAPENmaag.this, RPPENmaag.class);

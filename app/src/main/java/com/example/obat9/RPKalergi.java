...
public class RPKalergi extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.alergi1, R.drawable.alergi2, R.drawable.alergi3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkalergi);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsalergi);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKalergi.this, PKalergi.class);
        startActivity(intent);
        audioBackground.stop();
        RPKalergi.this.finish();
    }

...
public class PAPERgondongan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papergondongan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara026gondongan);
    ...
    public void onBackPressed() {
        ...
        PAPERgondongan.this.finish();
    }
    public void Rgondongan(View view) {
        Intent intent = new Intent(PAPERgondongan.this, RPPERgondongan.class);

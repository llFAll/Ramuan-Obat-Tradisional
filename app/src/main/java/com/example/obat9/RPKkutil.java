...
public class RPKkutil extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kutil1, R.drawable.kutil2};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpkkutil);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskutil);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPKkutil.this, PKkutil.class);
        startActivity(intent);
        audioBackground.stop();
        RPKkutil.this.finish();
    }

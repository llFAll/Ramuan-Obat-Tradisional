...
public class RPDtifus extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.tifus1, R.drawable.tifus2, R.drawable.tifus3, R.drawable.tifus4};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdtifus);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobattifus);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDtifus.this, PDtifus.class);
        startActivity(intent);
        audioBackground.stop();
        RPDtifus.this.finish();
    }

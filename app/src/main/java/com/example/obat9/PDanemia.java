...
public class PDanemia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdanemia);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara001anemia);
    ...
    public void onBackPressed() {
        ...
        PDanemia.this.finish();
    }
    public void RAnemia(View view) {
        Intent intent = new Intent(PDanemia.this, RPDanemia.class);

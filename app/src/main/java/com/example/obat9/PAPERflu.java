...
public class PAPERflu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperflu);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara025flu);
    ...
    public void onBackPressed() {
        ...
        PAPERflu.this.finish();
    }
    public void Rflu(View view) {
        Intent intent = new Intent(PAPERflu.this, RPPERflu.class);

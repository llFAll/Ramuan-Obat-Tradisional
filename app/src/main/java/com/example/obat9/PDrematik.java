...
public class PDrematik extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdrematik);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara007rematik);
    ...
    public void onBackPressed() {
        ...
        PDrematik.this.finish();

    }
    public void RRematik(View view) {
        Intent intent = new Intent(PDrematik.this, RPDrematik.class);

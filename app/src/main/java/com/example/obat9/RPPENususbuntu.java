...
public class RPPENususbuntu extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.radangususbantu1, R.drawable.radangususbantu2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppenususbuntu);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsradangususbuntu);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENususbuntu.this, PAPENradangususbuntu.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENususbuntu.this.finish();
    }

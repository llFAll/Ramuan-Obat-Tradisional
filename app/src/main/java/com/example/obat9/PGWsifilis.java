...
public class PGWsifilis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pgwsifilis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.sifilis);
    ...
    public void onBackPressed() {
        ...
        PGWsifilis.this.finish();
    }
    public void Rsifilis(View view) {
        Intent intent = new Intent(PGWsifilis.this, RPGsifilis.class);

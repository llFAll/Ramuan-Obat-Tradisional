...
public class PAPENhepatitis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papenhepatitis);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara015hepatitis);
    ...
    public void onBackPressed() {
        ...
        PAPENhepatitis.this.finish();
    }
    public void Rhepatitis(View view) {
        Intent intent = new Intent(PAPENhepatitis.this, RPPENhepatitis.class);

...
public class RPPERflu extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.flu1, R.drawable.flu2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpperflu);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsflu);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPERflu.this, PAPERflu.class);
        startActivity(intent);
        audioBackground.stop();
        RPPERflu.this.finish();
    }
    @Override

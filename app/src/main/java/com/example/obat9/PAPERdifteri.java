...
public class PAPERdifteri extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperdifteri);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara024difteri);
    ...
    public void onBackPressed() {
        ...
        PAPERdifteri.this.finish();
    }
    public void Rdifteri(View view) {
        Intent intent = new Intent(PAPERdifteri.this, RPPERdifteri.class);

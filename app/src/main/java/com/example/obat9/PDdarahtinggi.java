...
public class PDdarahtinggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pddarahtinggi);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara009tekanandarahtinggi);
    ...
    public void onBackPressed() {
        ...
        PDdarahtinggi.this.finish();
    }
    public void RTDT(View view) {
        Intent intent = new Intent(PDdarahtinggi.this, RPDdarahtinggi.class);

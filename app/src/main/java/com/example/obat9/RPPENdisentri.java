...
public class RPPENdisentri extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.disentri1, R.drawable.disentri1};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppendisentri);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rsdisentri);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENdisentri.this, PAPENdisentri.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENdisentri.this.finish();
    }

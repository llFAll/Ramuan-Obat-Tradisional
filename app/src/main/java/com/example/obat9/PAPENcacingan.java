...
public class PAPENcacingan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papencacingan);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara012cacingan);
    ...
    public void onBackPressed() {
        ...
        PAPENcacingan.this.finish();
    }
    public void Rcacingan(View view) {
        Intent intent = new Intent(PAPENcacingan.this, RPPENcacingan.class);

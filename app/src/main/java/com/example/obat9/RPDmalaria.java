...
public class RPDmalaria extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.malaria1, R.drawable.malaria2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpdmalaria);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatmalaria);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDmalaria.this, PDmalaria.class);
        startActivity(intent);
        audioBackground.stop();
        RPDmalaria.this.finish();
    }

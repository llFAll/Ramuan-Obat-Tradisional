...
public class PAPERasma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_paperasma);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara021asma);
    ...
    public void onBackPressed() {
        ...
        PAPERasma.this.finish();
    }
    public void Rasma(View view) {
        Intent intent = new Intent(PAPERasma.this, RPPERasma.class);

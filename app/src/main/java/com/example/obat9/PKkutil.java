...
public class PKkutil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pkkutil);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara017kutil);
    ...
    public void Rkutil(View view) {
        Intent intent = new Intent(PKkutil.this, RPKkutil.class);

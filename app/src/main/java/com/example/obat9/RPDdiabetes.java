...
public class RPDdiabetes extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.diabetes1, R.drawable.diabetes2};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rpddiabetes);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.resepobatdiabetes);
...
/*Mendefinisikan fungsi onToggleClicked dengan
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPDdiabetes.this, PDdiabetes.class);
        startActivity(intent);
        audioBackground.stop();
        RPDdiabetes.this.finish();
    }
    @Override

...
public class PAPENdiare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_papendiare);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara013diare);
    ...
    public void onBackPressed() {
        ...
        PAPENdiare.this.finish();
    }
    public void Rdiare(View view) {
        Intent intent = new Intent(PAPENdiare.this, RPPENdiare.class);

...
public class PDginjal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdginjal);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara002batuginjal);
    ...
    public void onBackPressed() {
        ...
        PDginjal.this.finish();

    }
    public void RGinjal(View view) {
        Intent intent = new Intent(PDginjal.this, RPDginjal.class);

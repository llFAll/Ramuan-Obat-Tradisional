...
public class RPPENkandungkemih extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kandungkemih1, R.drawable.kandungkemih2, R.drawable.kandungkemih3, R.drawable.kandungkemih4};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rppenkandungkemih);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.rskandungkemih);
    ...
    public void Jpenyakit(View view) {
        Intent intent = new Intent(RPPENkandungkemih.this, PAPENbatukandungkemih.class);
        startActivity(intent);
        audioBackground.stop();
        RPPENkandungkemih.this.finish();
    }

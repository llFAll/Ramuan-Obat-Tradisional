...
public class Nkencur extends AppCompatActivity {
    ...
    int[] sampleImages = {R.drawable.kencur1, R.drawable.kencur2, R.drawable.kencur3};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nkencur);
        ...
        audioBackground = MediaPlayer.create(this, R.raw.suara010kencur);
